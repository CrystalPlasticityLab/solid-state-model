...
void test_vector(){
    ...
    {
        pass_tests += expect((v11.get_comp_at_basis(basis1) == a1), "equal vector components");
        all_tests++;
    }
    {
    ...
    }
    {
        auto vr = v11 + v12;
        auto ar = a1 + a2;
        pass_tests += expect((vr.get_comp_at_basis(basis1) == ar), "check sum at different basis");
        all_tests++;
    }
    {
        auto vr = v11;
    ...
    }
    {
        auto vr = v11 - v12;
        auto ar = a1 - a2;
        pass_tests += expect((vr.get_comp_at_basis(basis1) == ar), "check sub at different basis");
        all_tests++;
    }
    {
